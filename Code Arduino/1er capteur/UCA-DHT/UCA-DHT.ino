...
static const u1_t PROGMEM DEVEUI[8] = { 0x17, 0x00, 0x00, 0x72, 0x00, 0x5F, 0x63, 0x20 };
...
static const u1_t PROGMEM APPKEY[16] = { 0xBA, 0x65, 0x3C, 0x1D, 0xCD, 0x5F, 0x97, 0x1E, 0x41, 0x1D, 0x0A, 0x57, 0x76, 0xB0, 0x95, 0x78 };
...
void setDataRate() {
  switch (LMIC.datarate) {
    ...
    case DR_SF7: 
    #ifdef SHOW_DEBUGINFO
    debugPrintLn(F("Datarate: SF7")); //NOUS (dans les librairies LoRa).
    #endif
      TX_INTERVAL = 180;
      break;
    case DR_SF7B: 
